...
namespace DeliveryService.Server.Migrations
{
    ...
    [Migration("20200712005244_AdditionToRoles2")]
    partial class AdditionToRoles2
    {
            ...
            modelBuilder.Entity("DeliveryService.Shared.Models.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Contact = "18762782795",
                            CreatedAt = new DateTime(2020, 7, 11, 19, 52, 44, 235, DateTimeKind.Local).AddTicks(6692),
                            ...
                            LastName = "franklin",
                            Nickname = "nove",
                            Salt = "vgyY9YZfI/db3zPQ7QeYq0H/ohgMk541K8iZBb9/6ariFxBrs6f2PVRdm2IRl2msv6E=",
                            Sex = 0
                        });
                });
